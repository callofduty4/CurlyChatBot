...
curlychatbot: netcode.o curlychatbot.o login.o connection.o
	$(cc) ${ccflags} netcode.o curlychatbot.o login.o connection.o -o curlychatbot -ljansson -lcurl
...
connection.o:	connection.c connection.h
	$(cc) connection.c -c ${ccflags} $(pkg-config --cflags jansson) $(pkg-config --cflags libcurl)
